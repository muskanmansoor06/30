...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 30, 2024 at 02:30 PM
...
INSERT INTO `create-creator-profile` (`profile_id`, `profile_img`, `first_name`, `last_name`, `city`, `gender`, `marital_status`, `age`, `country`, `category`, `description`, `bg_img`, `fb_url`, `insta_url`, `youtube_url`, `twitter_url`) VALUES
(26, 'Capture.PNG', 'Muskan', 'mansoor', 'karachi', 'Female', 'Single', 46, 'Canada', 'YouTuber', 'Enter Your Detail Information', '', '', '', '', ''),
(27, 'Capture.PNG', 'Muskan', 'mansoor', 'karachi', 'Female', 'Single', 18, 'Canada', 'YouTuber', 'Enter Your Detail Information', ']]].PNG', 'http://localhost/vission/html/app/profile-edit.php', 'http://localhost/vission/html/app/profile-edit.php', 'http://localhost/vission/html/app/profile-edit.php', 'http://localhost/vission/html/app/profile-edit.php'),
(28, 'Capture.PNG', 'muskan', 'mansoor', 'karachi', 'Female', 'Single', 18, 'Canada', 'YouTuber', 'Enter Your Detail Information', ']]].PNG', '', '', '', '');
